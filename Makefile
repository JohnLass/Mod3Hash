...
all: hopen1.test hput1.test hput2.test hsearch.test
...
hput2.test:		hput2.test.o hash.o queue.o listfun.o
							gcc $(CFLAGS) hash.o queue.o listfun.o hput2.test.c -o hput.test
...
clean:
				rm -f *.o hopen1.test hput1.test hput2.test hsearch.test
